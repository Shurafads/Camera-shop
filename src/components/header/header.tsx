      ...
      <div className="container">
        ...
        <nav className="main-nav header__main-nav">
          <ul className="main-nav__list">
            ...
            <li className="main-nav__item">
              <NavLink className={({ isActive }) => isActive ? 'main-nav__link main-nav__link--active' : 'main-nav__link'} to="/delivery">Доставка</NavLink>
            </li>
            <li className="main-nav__item">
              <NavLink className={({ isActive }) => isActive ? 'main-nav__link main-nav__link--active' : 'main-nav__link'} to="/about">О компании</NavLink>
            </li>
          </ul>
        </nav>
